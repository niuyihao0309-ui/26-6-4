...
# def batch_text():
#     from langchain_openai import ChatOpenAI
#     llm_ma = ChatOpenAI(model="deepseek-ai/DeepSeek-V4-Flash")
#     text1 = [
#         "1+1等于几",
#         "2+2等于几",
#         "3+3等于几"
#     ]
#     result1 = llm_ma.batch(text1)
#     for q,r in zip(text1,result1):
#         print(f"q:{q}")
#         print(f"r:{r.content}\n")
#
# batch_text()
...
"""abatch - 异步处理多个请求"""
async def main():
    llm_mi = ChatOpenAI(model="deepseek-ai/DeepSeek-V4-Flash")
    text2 = [
        "1+1等于几",
        "2+2等于几",
        "3+3等于几"
    ]
    result2 = await llm_mi.abatch(text2)
    for q,r in zip(text2,result2):
        print(f"q:{q},r:{r.content}\n")
